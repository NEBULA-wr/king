...
// USAMOS EL CONSTRUCTOR URL: Es la forma más profesional de manejar assets.
// Esto garantiza que Vite incluya las imágenes en el build de Netlify.
      ...
      <nav className="no-print sticky top-0 z-50 bg-white border-b border-slate-200 px-8 py-5 flex justify-between items-center shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-red-700 font-bold uppercase tracking-widest">Rosario Torres</p>
          </div>
        </div>
      ...
      <main className="flex-grow no-print">
        {activeTab === 'web' ? (
          <div className="max-w-[1400px] mx-auto p-8 lg:p-16 space-y-28 fade-in">
            ...
            <section className="bg-white border-y border-slate-200 py-24 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div className="space-y-12">
                ...
                <div className="grid grid-cols-1 gap-4 max-w-sm">
                  {teamMembers.map((m) => (
                    <div key={m.name} className="flex items-center justify-between border-b border-slate-100 pb-4">
            ...
            {/* UBICACIÓN Y TEXTO DE AUDITORÍA */}
