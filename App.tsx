          ...
          <div className="max-w-[1400px] mx-auto p-8 lg:p-16 space-y-28 fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              <section className="bg-slate-900 p-16 text-white border-l-[12px] border-red-700 shadow-2xl rounded-tr-3xl">
                ...
                <h3 className="text-4xl font-black uppercase mb-6 tracking-tighter">Objetivo de Auditoría</h3>
                <p className="text-slate-400 font-bold leading-relaxed text-2xl italic tracking-tighter">
                  "{reportContent.introduction.split('.')[0]}."
                </p>
              </section>
